...
export class DBMigration1642414937030 implements MigrationInterface {
    name = 'DBMigration1642414937030'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "task" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "description" character varying NOT NULL, "userId" text, "boardId" text, "columnId" text, "order" integer NOT NULL, CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`INSERT INTO "user" ("login", "name", "password") VALUES ('admin', 'admin', '$2a$10$bqc73pDA/mDxCOgsquRisuMYaWfm03FXjkHZ41qTO9JkrHpEXdJ76')`);
